...
class App
{
  ...
  private:
    ...
    void setDebugMessenger()
    {
        ...
        {
            throw std::runtime_error("Do not set up debug messenger\n");
        }
    }
    ...
    bool isDeviceSuitable(VkPhysicalDevice device)
    {
        ...
        bool extensionSupported = checkDeviceExtSupport(device);
    ...
    void pickPhysicalDevice()
    {
        ...
        if (deviceCount == 0)
        {
            throw std::runtime_error("Do not find any device\n");
        }
        ...
        {
            throw std::runtime_error("Do not find suitable devices\n");
        }
    }
    ...
    void createLogicalDevice()
    {
        ...
        {
            throw std::runtime_error("Do not create logical device\n");
        }
    ...
    void createRenderPass()
    {
        ...
        {
            throw std::runtime_error("failed to create render pas\n");
        }
    }
